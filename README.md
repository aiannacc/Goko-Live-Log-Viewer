...
Much of this project's original functionality was incorporated in the successor to that game client, available from [MakingFun](http://playdominion.com).  A [mod](http://forum.dominionstrategy.com/index.php?topic=14009.0) for that successor client also exists.  Its creator is currently producing a completely new Dominion game server, which is planned to eventually replace MakingFun's version.
